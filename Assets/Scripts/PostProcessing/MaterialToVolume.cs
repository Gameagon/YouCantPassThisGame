...
public class MaterialToVolume : VolumeComponent, IPostProcessComponent
{
    public BoolParameter render = new BoolParameter(value:true);

    // Other 'Parameter' variables you might have
    public MaterialParameter material = new MaterialParameter(value: null);

    

    // Tells when our effect should be rendered
    public bool IsActive() => render.value;
